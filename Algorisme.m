...
N_cares = 2; %Nº de cares recobertes amb poliurea
Una_cara = 1;
Dues_cares = 2;
...
Poliurea = 6; %Configuracio de poliurea utilitzada (E1, E2, F1, F2, N1, N2)
V_pic = 0.5; %Valor del pic de voltatge en el rang de temps determinat corresponent al 2n sensor mes proper a l'impacte (P2)
Energia = 0.03; %Valor d'energia calculat per aquest pic de tensio
